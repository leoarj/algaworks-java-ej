...
import com.github.leoarj.algaworks.course.ej.collections.sets.ibge.comparators.CidadeTotalHabitantesComparator;
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        //Set<Cidade> cidades = new TreeSet<>(new CidadeTotalHabitantesComparator());
