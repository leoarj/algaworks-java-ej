    ...
    public static void main(String[] args) {
        ...
        */
        ...
        try (Connection conexao = DriverManager.getConnection(
            ...
            // Desabilita o commit automático da transação
            // Necessário para controlar a transação (confirmação/reversão)
            ...
            try {
                ...
                // Confirma a transação caso nenhum erro ocorra
                conexao.commit();
            } catch (Exception e) {
                // Reverte as alterações caso algum erro ocorra
                conexao.rollback();
